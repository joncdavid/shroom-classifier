...
class ID3Tree:
    ...
    def print_rules(self):
        """Prints the rules generated by this tree."""
        self.print_rule_list( self.generate_rules() )

    def print_rule_list(self, rule_list):
        """Prints the rules in rule_list."""
        print("Printing generated rules.")
        i = 1
        for rule in rule_list:
            print("[R{}] ".format(i) + str(rule))
            i += 1
